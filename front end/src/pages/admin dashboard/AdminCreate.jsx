...
import {createTeacher} from '../../store/reducer/TeacherSlice';
          ...
          <div className="bg-white px-4 py-5 sm:p-6">
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:col-span-4">
                ...
                <input onChange={handleChange} type="text" name="email-address" id="email-address" autocomplete="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"/>
              </div>
              ...
              <div className="col-span-6">
                <label for="subjects" className="block text-sm font-medium text-gray-700">Subjects</label>
